...
/** @var backend\models\GalleryCategorySearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */
$this->title = 'Gallery Categories';
            ...
            <div class="card">
                ...
                $columns = [
                    ...
                    [
                        ...
                        'filter' => ['0' => 'Main', ArrayHelper::map(backend\models\GalleryCategory::find()->asArray()->all(), 'id', 'name')]
                    ],
                    'name',
                    [
                        'attribute' => 'status',
